    ...
    <div className="min-h-screen bg-background flex flex-col font-sans overflow-x-hidden">
      ...
      <nav className="w-full p-6 flex justify-between items-center border-b-2 border-black max-w-7xl mx-auto shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-2xl font-black text-white tracking-widest uppercase">CodeArena</span>
        </div>
      </nav>
      ...
      <main className="flex-1 flex flex-col justify-between items-center w-full max-w-7xl mx-auto px-6 py-6 md:py-10">
        ...
        <div className="text-center w-full max-w-4xl flex flex-col justify-center shrink-0">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-white uppercase tracking-tighter drop-shadow-[4px_4px_0px_#EF4444] leading-tight mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full my-6 md:my-0 flex-1 content-center">
          <div className="neo-card bg-[#1f1f1f] border-brand-blue p-6 lg:p-8 hover:-translate-y-2 hover:shadow-[6px_6px_0px_#3B82F6] transition-all flex flex-col justify-center h-full">
            ...
            <h2 className="text-xl lg:text-2xl font-black text-white uppercase tracking-widest mb-3">Execution Visualizer</h2>
          ...
          <div className="neo-card bg-[#1f1f1f] border-brand-yellow p-6 lg:p-8 hover:-translate-y-2 hover:shadow-[6px_6px_0px_#FACC15] transition-all flex flex-col justify-center h-full">
            ...
            <h2 className="text-xl lg:text-2xl font-black text-white uppercase tracking-widest mb-3">Debug Playground</h2>
            <p className="text-sm lg:text-base text-muted font-bold leading-relaxed">
              Fix real-world bugs in an interactive arena. Get hints and level up your problem-solving game.
            </p>
          </div>

          <div className="neo-card bg-[#1f1f1f] border-brand-red p-6 lg:p-8 hover:-translate-y-2 hover:shadow-[6px_6px_0px_#EF4444] transition-all flex flex-col justify-center h-full">
            ...
            <h2 className="text-xl lg:text-2xl font-black text-white uppercase tracking-widest mb-3">Error Explainer</h2>
            <p className="text-sm lg:text-base text-muted font-bold leading-relaxed">
      ...
      <footer className="border-t-2 border-black p-4 bg-[#0a0a0a] text-center w-full shrink-0">
        <p className="font-bold text-gray-600 uppercase tracking-widest text-xs md:text-sm">© 2026 CodeArena. Built for learners who want to actually understand code.</p>
      </footer>
    </div>
  );
}
