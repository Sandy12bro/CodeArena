...
export default function AIFeedbackBox() {
  return (
    <div className="neo-card neo-card-dark p-6 relative border-brand-blue">
      ...
      <h2 className="text-xl font-black uppercase tracking-widest text-white mb-6">Recent Performance</h2>

      <div className="space-y-4">
        <div className="flex items-start gap-4 neo-card bg-[#222] border-brand-blue p-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-white/90 leading-snug">Excellent logical reasoning on the graph cycle detection task.</p>
          </div>
        </div>

        <div className="flex items-start gap-4 neo-card bg-[#222] border-brand-red p-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-white/90 leading-snug">Time complexity for matrix traversal was O(N^3). Try dynamic programming.</p>
          </div>
        </div>

        <div className="flex items-start gap-4 neo-card bg-[#222] border-brand-yellow p-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-white/90 leading-snug">Review Bit Manipulation concepts to speed up aptitude math tasks by 20%.</p>
          </div>
        </div>
      </div>
    </div>
