  ...
  return (
    <div className="neo-card neo-card-dark p-6 w-full">
      <div className="flex justify-between items-end mb-4">
        ...
        <div className="text-2xl font-black text-foreground">450 <span className="text-brand-yellow text-lg">XP</span></div>
      </div>
      
      <div className="w-full bg-background h-8 neo-border rounded-lg relative overflow-hidden">
        {/* Animated stripes background using CSS linear-gradient */}
        <div 
          className="h-full bg-brand-blue border-r-2 border-border w-[45%] transition-all duration-1000 ease-out" 
        >
